...
*  ----------------------------------------------------------------------
*|length	|unsigned char	|0:��strlen�ж�		|�������涨���� <255
*  ----------------------------------------------------------------------
...
*|			|Type					|Example					|
*  ----------------------------------------------------------------------
*| input1	|char *str				|"5AEB8C"					|�������ݳ��ȱ�����˫��
*  ----------------------------------------------------------------------
*| input2	|unsigned char len_str	|6							|�ַ�������һ����˫�������߲�����ȷת����hex,����0����strlen����str����
*  ----------------------------------------------------------------------
*| input3	|char *hex				|char hex[3]:���ڴ洢���	|
*  ----------------------------------------------------------------------
*| output2	|char *hex				|hex[3] = {0x5A,0XEB,0X8C}	|
*  ----------------------------------------------------------------------
*| return	|char					|0:SUCCESS	|-1:���볤������|
*  ----------------------------------------------------------------------*/
