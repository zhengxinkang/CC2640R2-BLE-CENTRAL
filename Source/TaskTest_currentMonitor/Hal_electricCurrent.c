    ...
    if(Test_process_getStatus())
    {
        ...
        if(status_record)
        {
            if(status_record <= 160 )
            {
                ...
                Hal_abnormal_recordText(status_record, current, currentThist, second);
