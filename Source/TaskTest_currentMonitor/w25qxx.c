...
//
////-------------
//unsigned int W25QXX_TYPE=W25Q128;	//默认是W25Q128
//
////4Kbytes为一个Sector
////16个扇区为1个Block
////W25Q128
...
//	GPIO_PinOutClear(GPIO_FLASH_SPI_CS, BIT_FLASH_SPI_CS);                            //使能器件
//	SPI2_ReadWriteByte(W25X_ReadStatusReg); //发送读取状态寄存器命令
//	byte=SPI2_ReadWriteByte(0Xff);          //读取一个字节
//	GPIO_PinOutSet(GPIO_FLASH_SPI_CS, BIT_FLASH_SPI_CS);                            //取消片选
//	return byte;
//}
////写W25QXX状态寄存器
...
//    {
//        TRACE_ERROR("hFlashSpiPin 打开失败！致命错误！\n");
//    }
//    else
//    {
//        TRACE_CODE("hFlashSpiPin 打开成功。\n");
//    }
//
//    GPIO_PinOutClear(GPIO_FLASH_SPI_CS, BIT_FLASH_SPI_CS);
